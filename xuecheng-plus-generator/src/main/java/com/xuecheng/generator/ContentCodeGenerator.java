...
public class ContentCodeGenerator {
	...
	//数据库密码
	private static final String DATA_SOURCE_PASSWORD  = "q";
	//生成的表
	private static final String[] TABLE_NAMES = new String[]{
// TODO: change this to set what table you need to generated
//			"mq_message",
//			"mq_message_history"
			 "course_base",
			 "course_market",
	...
	public static void main(String[] args) {
		...
		// 数据库配置
		// TODO: change this to set correct mysql
		DataSourceConfig dsc = new DataSourceConfig();
		dsc.setDbType(DbType.MYSQL);
		dsc.setUrl("jdbc:mysql://127.0.0.1:4306/xc402_" + SERVICE_NAME
